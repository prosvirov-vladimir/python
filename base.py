...
print(round(4.5678, 2)) # округлить до двух знаков после запятой/точки
print(round(4.5))
print(round(5.5))
print(round(3.5))

# математические функции в библиотеке math
print("-------------------")
print(math.ceil(5.7)) # ceil округляет в большую строну
print(math.ceil(5.2))
print(math.floor(5.8)) # floor округляет в меньшую сторону
print(math.floor(5.2))
print(math.log(25, 2)) # логарифм 25 по основанию 2
print(math.sqrt(25)) # найти квадратный корень из числа 25